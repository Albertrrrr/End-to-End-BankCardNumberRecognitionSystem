...
def load_tf_model():
    # load config file
    # change this path
    cfg.TEST.checkpoints_path = (os.getcwd() + r'/CardPositioning/checkpoints')
    #cfg.TEST.checkpoints_path = "/home/zhang/CTPNOCR/SourceCode/CardPositioning/checkpoints"
    # init session
...
if __name__ == '__main__':
    ...
    cfg_from_file('./CardPositioning/CardPositioning/text.yml')
