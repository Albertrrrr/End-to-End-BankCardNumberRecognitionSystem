...
path = '/media/D/code/OCR/text-detection-CardPositioning/data/mlt_english+chinese/image'
gt_path = '/media/D/code/OCR/text-detection-CardPositioning/data/mlt_english+chinese/label'
out_path = 're_image'
