...
sys.path.append(os.getcwd() + '/CardPositioning')
from text_detect import text_detect
from lib.fast_rcnn.config import cfg_from_file
from CardRecognition.model import predict as keras_densenet
...
def model(img, adjust=False):
    ...
    请改变cfg_from_file的目录
    """
    cfg_from_file(os.getcwd() + r'/CardPositioning/ctpn/text.yml')
    #cfg_from_file(r'/home/zhang/CTPNOCR/SourceCode/CardPositioning/ctpn/text.yml')
